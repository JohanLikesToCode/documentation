...
<Check>
  This page focuses on how to _use_ the codes and apply them in realistic radio traffic.
</Check>
...
`Dispatch: Signal 100 in effect for active pursuit — hold all non-emergency transmissions.`
